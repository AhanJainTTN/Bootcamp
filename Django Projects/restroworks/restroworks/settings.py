"""
Django settings for restroworks project.
...
SECRET_KEY = "django-insecure-kob%r(&)wfb(f_^%e#78ivuyf!82)n1h(%xd$8dsbc3@v@7y5u"
...
MIDDLEWARE = [
    ...
    # "middleware.request_metadata_middleware.RequestMetadataMiddleware",
...
WSGI_APPLICATION = "restroworks.wsgi.application"
