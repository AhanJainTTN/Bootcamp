...
def retrieve_and_write():
    ...
    for instance in instances:
        ...
        encryption, kms_key_id = get_rds_encryption(inst_id)
        rds_data.append([inst_id, engine, db_class, encryption, kms_key_id, project])
    ...
    for vol in volumes:
        ...
        encryption, kms_key_id = get_ebs_encryption(vol_id)
        ebs_data.append([vol_id, state, attach, encryption, kms_key_id, project])
