...
def main() -> None:
    ...
    id_path = "Week_03_Python_for_Development/Day_02_Regular_Expression_and_Text_Processing/Exercises/ex_01_NPI_scraper/files/npi_ids.pkl"
    npi_ids = load_ids(id_path)

    extracted_data = process_all_ids(npi_ids)

    json_path = "Week_03_Python_for_Development/Day_02_Regular_Expression_and_Text_Processing/Exercises/ex_01_NPI_scraper/files/results.json"
